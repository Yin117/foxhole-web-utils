...
import * as wc122 from './Map_Dynamic_WC122.json';
import * as wc123 from './Map_Dynamic_WC123.json';
import * as wc124 from './Map_Dynamic_WC124.json';
import * as wc125 from './Map_Dynamic_WC125.json';
import * as wc126 from './Map_Dynamic_WC126.json';
import * as wc127 from './Map_Dynamic_WC127.json';
import * as wc128 from './Map_Dynamic_WC128.json';
import * as wc129 from './Map_Dynamic_WC129.json';
import * as wc130 from './Map_Dynamic_WC130.json';
...
import * as wc135 from './Map_Dynamic_WC135.json'; // Platforms discontinued in the API
import * as wc136 from './Map_Dynamic_WC136.json';
import * as wc137 from './Map_Dynamic_WC137.json';
import * as wc138 from './Map_Dynamic_WC138.json';
...
export const warNumberToMapDynamic = new Map<string, MapDynamic[]>([
  ['138', wc138 as MapDynamic[]],
  ['137', wc137 as MapDynamic[]],
  ['136', wc136 as MapDynamic[]],
  ['135', wc135 as MapDynamic[]],
  ['134', wc134 as MapDynamic[]],
  ['133', wc133 as MapDynamic[]],
  ['132', wc132 as MapDynamic[]],
  ['131', wc131 as MapDynamic[]],
  ['130', wc130 as MapDynamic[]],
  ['129', wc129 as MapDynamic[]],
  ['128', wc128 as MapDynamic[]],
  ['127', wc127 as MapDynamic[]],
  ['126', wc126 as MapDynamic[]],
